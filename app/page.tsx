...
const ImageGallery = ({ images, ministry }: { images: string[]; ministry: any }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        onClick={() => openLightbox(images[activeImage] || "/placeholder.svg")}
      >
        <Image
          src={images[activeImage] || "/placeholder.svg"}
          alt={`${ministry.name} featured`}
          fill
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        {images.slice(1).map((image, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 border-2 border-transparent group-hover:border-white/50 rounded-xl transition-all duration-300" />
          </motion.div>
        ))}
      </div>
    ...
    <section ref={ref} className="py-20 relative overflow-hidden" id={ministry.id}>
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12">
        ...
        >
          ...
          >
            <ImageGallery images={ministry.images} ministry={ministry} />
          </motion.div>
        </div>
      </div>
...
export default function Page() {
  ...
  const scrollToMinistry = (ministryId: string) => {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4 sm:space-x-6 lg:space-x-8">
                  ...
                  {ministriesDropdownOpen && (
                    ...
                    >
                      {ministries.map((ministry) => (
                        <button
                          key={ministry.id}
                          onClick={() => scrollToMinistry(ministry.id)}
              ...
              <Button
                ...
                className="bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-full px-2 sm:px-3 lg:px-4 text-sm sm:text-base py-2"
              >
                Visit Us
              </Button>
            </div>
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <motion.p
            ...
            className="text-2xl sm:text-3xl text-gray-200 mb-12 max-w-3xl mx-auto leading-relaxed"
          >
            Find your calling. Join a team. Serve with purpose.
          </motion.p>
      ...
      <section className="py-16 md:py-24 lg:py-32 bg-gradient-to-br from-indigo-50 to-purple-50 relative overflow-hidden">
